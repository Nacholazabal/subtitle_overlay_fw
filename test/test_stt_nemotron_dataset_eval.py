...
from scripts.stt_dataset_manifest import DatasetClip
from scripts.stt_nemotron_dataset_eval import (
...
class NotebookContractTests(unittest.TestCase):
    def test_notebook_is_offline_then_streaming_and_has_no_server_transport(self):
        notebook = json.loads(
            (Path(__file__).resolve().parents[1] / "scripts" / "colab_nemotron_dataset_eval.ipynb")
