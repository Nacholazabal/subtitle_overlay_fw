...
static const uint32_t filter_lookup_low[64] = {
    0b0001011111U, 0b0001010111U, 0b0001111011U, 0b0001011011U,
    0b0001101011U, 0b0001110011U, 0b0001110011U, 0b0001110011U,
    0b0001110011U, 0b0001001011U, 0b0001001011U, 0b0001001011U,
    0b0010110011U, 0b0001010011U, 0b0001010011U, 0b0001010011U,
    0b0001010011U, 0b0001010011U, 0b0001010011U, 0b0001010011U,
    0b0001010011U, 0b0001010011U, 0b0001010011U, 0b0001100011U,
    0b0001100011U, 0b0001100011U, 0b0001100011U, 0b0001100011U,
    0b0001100011U, 0b0001100011U, 0b0001100011U, 0b0001100011U,
    0b0001100011U, 0b0001100011U, 0b0001100011U, 0b0001100011U,
    0b0001100011U, 0b0010010011U, 0b0010010011U, 0b0010010011U,
    0b0010010011U, 0b0010010011U, 0b0010010011U, 0b0010010011U,
    0b0010010011U, 0b0010010011U, 0b0010010011U, 0b0010100011U,
...
{
    if ((reg_values == NULL) || (clk_params == NULL) ||
        (clk_params->fbmult < 2U) || (clk_params->fbmult > 64U))
    {
        return 0;
    }
    ...
    if ((reg_values->clk0_l == ERR_CLKCOUNTCALC) ||
        (reg_values->clk_fb_l == ERR_CLKCOUNTCALC) ||
    ...
    reg_values->fltr_lock_h = (uint32_t)((lock_lookup[clk_params->fbmult - 1U] >> 32U) & 0x000000FFULL);
...
static double clk_find_params(double frequency_mhz, clk_mode_t* const best_pick)
{
    ...
    for (cur_div = 1U; cur_div <= 10U; cur_div++)
    {
        ...
        for (cur_fb = min_fb; cur_fb <= max_fb; cur_fb++)
        {
            ...
            double const cur_freq = ((100.0 / (double)cur_div) / (double)cur_clk_div) * (double)cur_fb;
