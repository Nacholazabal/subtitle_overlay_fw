...
///
/// @file log2fix.c
/// @brief Source file for fixed-point logarithm functions.
///
/// This file contains the implementation of functions that compute logarithms in fixed-point arithmetic. The supported
...
{
    uint64_t t = log2fix(x, precision) * INV_LOG2_E_Q1DOT31;
    return t >> 31;
}

int32_t log10fix(uint32_t x, size_t precision)
{
    uint64_t t = log2fix(x, precision) * INV_LOG2_10_Q1DOT31;
    return t >> 31;
}
