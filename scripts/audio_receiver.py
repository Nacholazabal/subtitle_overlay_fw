...
from scripts.stt_receiver import TcpTranscriptSink
...
class TcpSubtitleSink(TcpTranscriptSink, SubtitleSink):
    """Compatibility name for the shared production subtitle protocol sink."""
