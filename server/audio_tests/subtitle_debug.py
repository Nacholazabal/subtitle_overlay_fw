...
Usage:
  python -m server.audio_tests.subtitle_debug [events.jsonl]
  python -m server.audio_tests.subtitle_debug --follow [path]
  python -m server.audio_tests.subtitle_debug --all [path]
"""
